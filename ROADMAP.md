...
- ✅ Слой 2 (начало): извличане от PDF → ЧЕРНОВА (`extract.py`) — ароматни
      алергени (IFF/Symrise), числови/диапазонни композиции (Phenbiox) и
      легенда-кодирани A–G (ARDA). Валидирано срещу реални документи.
